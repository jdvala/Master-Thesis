...
The EUR-Lex data set is an imbalanced data. That is the number of instances across the classes is not even as shown in \ref{fig:dataimbalance}.
...
(Transport, 201) };
  ...
  \end{axis}
  \end{tikzpicture}
      \caption{Data Distribution of EUR-Lex summaries}
